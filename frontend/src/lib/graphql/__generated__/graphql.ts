...
export type GetTrackedParcelsIdsQuery = {
  __typename?: 'Query'
  trackedParcelsIds?: Array<any> | null
}
...
export type GetPostOfficesQuery = {
  __typename?: 'Query'
  postOfficesOffset?: {
    __typename?: 'PostOfficesOffsetCollectionSegment'
    totalCount: number
...
export type ParcelCardItemFragment = {
  __typename?: 'Parcel'
  id: any
  updatedAt?: any | null
  parcelInfo: {
...
export type ParcelCardStatusItemFragment = {
  __typename?: 'Parcel'
  currentStatus?: {
    __typename?: 'ParcelStatus'
    statusDescription: string
...
export type ParcelDeliveryPathItemFragment = {
  __typename?: 'Parcel'
  parcelInfo: {
    __typename?: 'ParcelInfo'
    deliveryDestinationAddress: string
...
export type ParcelProgressItemFragment = {
  __typename?: 'Parcel'
  currentStatus?: {
    __typename?: 'ParcelStatus'
    deliveryStatus?: {
...
export type GetParcelForPageQuery = {
  __typename?: 'Query'
  parcelById?: {
    __typename?: 'Parcel'
    id: any
...
export type ParcelPageItemFragment = {
  __typename?: 'Parcel'
  id: any
  updatedAt?: any | null
  parcelInfo: {
...
export type ParcelPageStatusBlockItemFragment = {
  __typename?: 'ParcelStatus'
  id: any
  date: any
  statusDescription: string
...
export type ParcelPageStatusesListItemFragment = {
  __typename?: 'Parcel'
  parcelStatusHistory: Array<{
    __typename?: 'ParcelStatus'
    id: any
...
export type ParcelStatusUpdatesSubscription = {
  __typename?: 'Subscription'
  parcelStatusUpdated?: {
    __typename?: 'ParcelStatus'
    updatedAt?: any | null
...
export type GetParcelForSearchQuery = {
  __typename?: 'Query'
  parcelById?: { __typename?: 'Parcel'; id: any } | null
}

export type PostOfficeCardItemFragment = {
  __typename?: 'PostOffice'
  id: any
  code: string
  address: string
...
export type ResolversTypes = ResolversObject<{
  AddDeliveryStatusError: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['AddDeliveryStatusError']
  >
  AddDeliveryStatusInput: AddDeliveryStatusInput
  AddDeliveryStatusPayload: ResolverTypeWrapper<
    Omit<AddDeliveryStatusPayload, 'errors'> & {
      errors?: Maybe<Array<ResolversTypes['AddDeliveryStatusError']>>
    }
  >
  AddParcelInput: AddParcelInput
  AddParcelPayload: ResolverTypeWrapper<AddParcelPayload>
  AddPostOfficeError: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['AddPostOfficeError']
  >
  AddPostOfficeInput: AddPostOfficeInput
  AddPostOfficePayload: ResolverTypeWrapper<
    Omit<AddPostOfficePayload, 'errors'> & {
      errors?: Maybe<Array<ResolversTypes['AddPostOfficeError']>>
    }
  >
  ...
  PushOneMoreParcelStatusError: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>['PushOneMoreParcelStatusError']
  >
  PushOneMoreParcelStatusInput: PushOneMoreParcelStatusInput
  PushOneMoreParcelStatusPayload: ResolverTypeWrapper<
    Omit<PushOneMoreParcelStatusPayload, 'errors'> & {
      errors?: Maybe<Array<ResolversTypes['PushOneMoreParcelStatusError']>>
    }
  >
...
export type ResolversParentTypes = ResolversObject<{
  ...
  AddDeliveryStatusInput: AddDeliveryStatusInput
  AddDeliveryStatusPayload: Omit<AddDeliveryStatusPayload, 'errors'> & {
    errors?: Maybe<Array<ResolversParentTypes['AddDeliveryStatusError']>>
  }
  AddParcelInput: AddParcelInput
  AddParcelPayload: AddParcelPayload
  AddPostOfficeError: ResolversUnionTypes<ResolversParentTypes>['AddPostOfficeError']
  AddPostOfficeInput: AddPostOfficeInput
  AddPostOfficePayload: Omit<AddPostOfficePayload, 'errors'> & {
    errors?: Maybe<Array<ResolversParentTypes['AddPostOfficeError']>>
  }
  ...
  PushOneMoreParcelStatusInput: PushOneMoreParcelStatusInput
  PushOneMoreParcelStatusPayload: Omit<
    PushOneMoreParcelStatusPayload,
    'errors'
  > & {
    errors?: Maybe<Array<ResolversParentTypes['PushOneMoreParcelStatusError']>>
  }
  Query: {}
...
export type AddDeliveryStatusErrorResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['AddDeliveryStatusError'] = ResolversParentTypes['AddDeliveryStatusError']
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'ParcelTrackingServiceError',
    ParentType,
    ContextType
  >
}>

export type AddDeliveryStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['AddDeliveryStatusPayload'] = ResolversParentTypes['AddDeliveryStatusPayload']
> = ResolversObject<{
  ...
  >
  errors?: Resolver<
    Maybe<Array<ResolversTypes['AddDeliveryStatusError']>>,
    ParentType,
    ContextType
  >
...
export type AddParcelPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['AddParcelPayload'] = ResolversParentTypes['AddParcelPayload']
> = ResolversObject<{
  parcel?: Resolver<Maybe<ResolversTypes['Parcel']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type AddPostOfficeErrorResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['AddPostOfficeError'] = ResolversParentTypes['AddPostOfficeError']
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'ParcelTrackingServiceError',
    ParentType,
...
export type AddPostOfficePayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['AddPostOfficePayload'] = ResolversParentTypes['AddPostOfficePayload']
> = ResolversObject<{
  errors?: Resolver<
    Maybe<Array<ResolversTypes['AddPostOfficeError']>>,
    ParentType,
    ContextType
  >
  postOffice?: Resolver<
    Maybe<ResolversTypes['PostOffice']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type CollectionSegmentInfoResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['CollectionSegmentInfo'] = ResolversParentTypes['CollectionSegmentInfo']
> = ResolversObject<{
...
export type DeleteDeliveryStatusByIdPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeleteDeliveryStatusByIdPayload'] = ResolversParentTypes['DeleteDeliveryStatusByIdPayload']
> = ResolversObject<{
  deliveryStatus?: Resolver<
    Maybe<ResolversTypes['DeliveryStatus']>,
    ParentType,
...
export type DeleteParcelByIdPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeleteParcelByIdPayload'] = ResolversParentTypes['DeleteParcelByIdPayload']
> = ResolversObject<{
  parcel?: Resolver<Maybe<ResolversTypes['Parcel']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type DeletePostOfficeByIdPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeletePostOfficeByIdPayload'] = ResolversParentTypes['DeletePostOfficeByIdPayload']
> = ResolversObject<{
  postOffice?: Resolver<
    Maybe<ResolversTypes['PostOffice']>,
    ParentType,
...
export type DeliveryStatusResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeliveryStatus'] = ResolversParentTypes['DeliveryStatus']
> = ResolversObject<{
  createdAt?: Resolver<
    ...
    ContextType
  >
  generalDeliveryState?: Resolver<
    ResolversTypes['GeneralDeliveryState'],
    ParentType,
    ContextType
  >
...
export type DeliveryStatusesConnectionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeliveryStatusesConnection'] = ResolversParentTypes['DeliveryStatusesConnection']
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<ResolversTypes['DeliveryStatusesEdge']>>,
    ParentType,
    ContextType
  >
  nodes?: Resolver<
    Maybe<Array<ResolversTypes['DeliveryStatus']>>,
    ParentType,
    ContextType
  >
...
export type DeliveryStatusesEdgeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['DeliveryStatusesEdge'] = ResolversParentTypes['DeliveryStatusesEdge']
> = ResolversObject<{
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'ParcelNotFoundError' | 'ParcelTrackingServiceError',
    ParentType,
    ContextType
  >
...
> = ResolversObject<{
  addDeliveryStatus?: Resolver<
    ResolversTypes['AddDeliveryStatusPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationAddDeliveryStatusArgs, 'input'>
  >
  addParcel?: Resolver<
    ResolversTypes['AddParcelPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationAddParcelArgs, 'input'>
  >
  addPostOffice?: Resolver<
    ResolversTypes['AddPostOfficePayload'],
    ParentType,
    ContextType,
    RequireFields<MutationAddPostOfficeArgs, 'input'>
  >
  deleteDeliveryStatusById?: Resolver<
    ResolversTypes['DeleteDeliveryStatusByIdPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteDeliveryStatusByIdArgs, 'input'>
  >
  deleteParcelById?: Resolver<
    ResolversTypes['DeleteParcelByIdPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteParcelByIdArgs, 'input'>
  >
  deletePostOfficeById?: Resolver<
    ResolversTypes['DeletePostOfficeByIdPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationDeletePostOfficeByIdArgs, 'input'>
  >
  pushOneMoreParcelStatus?: Resolver<
    ResolversTypes['PushOneMoreParcelStatusPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationPushOneMoreParcelStatusArgs, 'input'>
  >
  updateDeliveryStatus?: Resolver<
    ResolversTypes['UpdateDeliveryStatusPayload'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateDeliveryStatusArgs, 'input'>
  >
  updatePostOffice?: Resolver<
    ResolversTypes['UpdatePostOfficePayload'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdatePostOfficeArgs, 'input'>
  >
}>
...
export type ParcelResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['Parcel'] = ResolversParentTypes['Parcel']
> = ResolversObject<{
  createdAt?: Resolver<
    Maybe<ResolversTypes['DateTime']>,
    ParentType,
  ...
  currentStatus?: Resolver<
    Maybe<ResolversTypes['ParcelStatus']>,
    ParentType,
    ContextType
  >
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>
  ...
  parcelStatusHistory?: Resolver<
    Array<ResolversTypes['ParcelStatus']>,
    ParentType,
    ContextType
  >
  updatedAt?: Resolver<
...
export type ParcelHistoryConnectionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelHistoryConnection'] = ResolversParentTypes['ParcelHistoryConnection']
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<ResolversTypes['ParcelHistoryEdge']>>,
    ParentType,
    ContextType
  >
  nodes?: Resolver<
    Maybe<Array<ResolversTypes['ParcelStatus']>>,
    ParentType,
    ContextType
  >
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>
...
export type ParcelHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelHistoryEdge'] = ResolversParentTypes['ParcelHistoryEdge']
> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ParcelInfoResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelInfo'] = ResolversParentTypes['ParcelInfo']
> = ResolversObject<{
  createdAt?: Resolver<
    Maybe<ResolversTypes['DateTime']>,
    ParentType,
    ContextType
  >
  deliveryDestinationAddress?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType
  >
  deliverySourceAddress?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType
  >
...
export type ParcelNotFoundErrorResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelNotFoundError'] = ResolversParentTypes['ParcelNotFoundError']
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type ParcelStatusResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelStatus'] = ResolversParentTypes['ParcelStatus']
> = ResolversObject<{
  createdAt?: Resolver<
    Maybe<ResolversTypes['DateTime']>,
    ParentType,
...
export type ParcelTrackingServiceErrorResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelTrackingServiceError'] = ResolversParentTypes['ParcelTrackingServiceError']
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>

export type ParcelsCursorConnectionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelsCursorConnection'] = ResolversParentTypes['ParcelsCursorConnection']
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<ResolversTypes['ParcelsCursorEdge']>>,
    ParentType,
    ContextType
  >
  nodes?: Resolver<
    Maybe<Array<ResolversTypes['Parcel']>>,
    ParentType,
    ContextType
  >
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>
...
export type ParcelsCursorEdgeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelsCursorEdge'] = ResolversParentTypes['ParcelsCursorEdge']
> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ParcelsOffsetCollectionSegmentResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['ParcelsOffsetCollectionSegment'] = ResolversParentTypes['ParcelsOffsetCollectionSegment']
> = ResolversObject<{
  items?: Resolver<
    Maybe<Array<ResolversTypes['Parcel']>>,
    ParentType,
...
export type PostOfficeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PostOffice'] = ResolversParentTypes['PostOffice']
> = ResolversObject<{
...
export type PostOfficesCursorConnectionResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PostOfficesCursorConnection'] = ResolversParentTypes['PostOfficesCursorConnection']
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<ResolversTypes['PostOfficesCursorEdge']>>,
    ParentType,
    ContextType
  >
  nodes?: Resolver<
    Maybe<Array<ResolversTypes['PostOffice']>>,
    ParentType,
    ContextType
  >
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>
...
export type PostOfficesCursorEdgeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PostOfficesCursorEdge'] = ResolversParentTypes['PostOfficesCursorEdge']
> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type PostOfficesOffsetCollectionSegmentResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PostOfficesOffsetCollectionSegment'] = ResolversParentTypes['PostOfficesOffsetCollectionSegment']
> = ResolversObject<{
  items?: Resolver<
    Maybe<Array<ResolversTypes['PostOffice']>>,
    ParentType,
...
export type PushOneMoreParcelStatusErrorResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PushOneMoreParcelStatusError'] = ResolversParentTypes['PushOneMoreParcelStatusError']
> = ResolversObject<{
  __resolveType: TypeResolveFn<'ParcelNotFoundError', ParentType, ContextType>
}>

export type PushOneMoreParcelStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['PushOneMoreParcelStatusPayload'] = ResolversParentTypes['PushOneMoreParcelStatusPayload']
> = ResolversObject<{
  errors?: Resolver<
    Maybe<Array<ResolversTypes['PushOneMoreParcelStatusError']>>,
    ParentType,
    ContextType
  >
  parcel?: Resolver<
...
> = ResolversObject<{
  currentParcelStatus?: Resolver<
    Maybe<ResolversTypes['ParcelStatus']>,
    ParentType,
    ContextType,
    RequireFields<QueryCurrentParcelStatusArgs, 'parcelId'>
  >
  deliveryStatuses?: Resolver<
    Maybe<ResolversTypes['DeliveryStatusesConnection']>,
    ParentType,
    ContextType,
    Partial<QueryDeliveryStatusesArgs>
  >
  parcelById?: Resolver<
    Maybe<ResolversTypes['Parcel']>,
    ParentType,
    ContextType,
    RequireFields<QueryParcelByIdArgs, 'parcelId'>
  >
  parcelHistory?: Resolver<
    Maybe<ResolversTypes['ParcelHistoryConnection']>,
    ParentType,
    ContextType,
    RequireFields<QueryParcelHistoryArgs, 'parcelId'>
  >
  parcelsCursor?: Resolver<
    Maybe<ResolversTypes['ParcelsCursorConnection']>,
    ParentType,
    ContextType,
    Partial<QueryParcelsCursorArgs>
  >
  parcelsOffset?: Resolver<
    Maybe<ResolversTypes['ParcelsOffsetCollectionSegment']>,
    ParentType,
    ContextType,
    Partial<QueryParcelsOffsetArgs>
  >
  postOfficesCursor?: Resolver<
    Maybe<ResolversTypes['PostOfficesCursorConnection']>,
    ParentType,
    ContextType,
    Partial<QueryPostOfficesCursorArgs>
  >
  postOfficesOffset?: Resolver<
    Maybe<ResolversTypes['PostOfficesOffsetCollectionSegment']>,
    ParentType,
    ContextType,
    Partial<QueryPostOfficesOffsetArgs>
  >
  trackedParcelsIds?: Resolver<
    Maybe<Array<ResolversTypes['UUID']>>,
    ParentType,
    ContextType
  >
}>
...
> = ResolversObject<{
  deliveryStatusCreated?: SubscriptionResolver<
    Maybe<ResolversTypes['DeliveryStatus']>,
    'deliveryStatusCreated',
    ParentType,
    ContextType
  >
  deliveryStatusDeleted?: SubscriptionResolver<
    Maybe<ResolversTypes['DeliveryStatus']>,
    'deliveryStatusDeleted',
    ParentType,
    ContextType
  >
  deliveryStatusUpdated?: SubscriptionResolver<
    Maybe<ResolversTypes['DeliveryStatus']>,
    'deliveryStatusUpdated',
    ParentType,
    ContextType
  >
  parcelStatusUpdated?: SubscriptionResolver<
    Maybe<ResolversTypes['ParcelStatus']>,
    'parcelStatusUpdated',
    ParentType,
    ContextType,
    RequireFields<SubscriptionParcelStatusUpdatedArgs, 'parcelId'>
  >
  postOfficeCreated?: SubscriptionResolver<
    Maybe<ResolversTypes['PostOffice']>,
    'postOfficeCreated',
    ParentType,
    ContextType
  >
  postOfficeDeleted?: SubscriptionResolver<
    Maybe<ResolversTypes['PostOffice']>,
    'postOfficeDeleted',
    ParentType,
    ContextType
  >
  postOfficeUpdated?: SubscriptionResolver<
    Maybe<ResolversTypes['PostOffice']>,
    'postOfficeUpdated',
    ParentType,
    ContextType,
    RequireFields<SubscriptionPostOfficeUpdatedArgs, 'postOfficeId'>
  >
}>
...
export type UpdateDeliveryStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['UpdateDeliveryStatusPayload'] = ResolversParentTypes['UpdateDeliveryStatusPayload']
> = ResolversObject<{
  deliveryStatus?: Resolver<
    Maybe<ResolversTypes['DeliveryStatus']>,
    ParentType,
...
export type UpdatePostOfficePayloadResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['UpdatePostOfficePayload'] = ResolversParentTypes['UpdatePostOfficePayload']
> = ResolversObject<{
  postOffice?: Resolver<
    Maybe<ResolversTypes['PostOffice']>,
    ParentType,
 ...
 * });
 */
export function useGetParcelsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetParcelsQuery,
    GetParcelsQueryVariables
  > &
    (
      | { variables: GetParcelsQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetParcelsQuery, GetParcelsQueryVariables>(
    GetParcelsDocument,
    options
  )
}
export function useGetParcelsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetParcelsQuery, GetParcelsQueryVariables>(
    GetParcelsDocument,
    options
  )
}
export function useGetParcelsSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<GetParcelsQuery, GetParcelsQueryVariables>(
    GetParcelsDocument,
    options
  )
}
export type GetParcelsQueryHookResult = ReturnType<typeof useGetParcelsQuery>
export type GetParcelsLazyQueryHookResult = ReturnType<
  typeof useGetParcelsLazyQuery
>
export type GetParcelsSuspenseQueryHookResult = ReturnType<
  typeof useGetParcelsSuspenseQuery
>
export type GetParcelsQueryResult = Apollo.QueryResult<
  GetParcelsQuery,
  GetParcelsQueryVariables
>
 ...
 * });
 */
export function useGetTrackedParcelsIdsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetTrackedParcelsIdsQuery,
    GetTrackedParcelsIdsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetTrackedParcelsIdsQuery,
    GetTrackedParcelsIdsQueryVariables
  >(GetTrackedParcelsIdsDocument, options)
}
export function useGetTrackedParcelsIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTrackedParcelsIdsQuery,
    GetTrackedParcelsIdsQueryVariables
  >
...
export function useGetTrackedParcelsIdsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetTrackedParcelsIdsQuery,
    GetTrackedParcelsIdsQueryVariables
  >
...
export type GetTrackedParcelsIdsQueryHookResult = ReturnType<
  typeof useGetTrackedParcelsIdsQuery
>
export type GetTrackedParcelsIdsLazyQueryHookResult = ReturnType<
  typeof useGetTrackedParcelsIdsLazyQuery
>
export type GetTrackedParcelsIdsSuspenseQueryHookResult = ReturnType<
  typeof useGetTrackedParcelsIdsSuspenseQuery
>
export type GetTrackedParcelsIdsQueryResult = Apollo.QueryResult<
  GetTrackedParcelsIdsQuery,
  GetTrackedParcelsIdsQueryVariables
>
 ...
 * });
 */
export function useGetPostOfficesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetPostOfficesQuery,
    GetPostOfficesQueryVariables
  > &
    (
      | { variables: GetPostOfficesQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetPostOfficesQuery, GetPostOfficesQueryVariables>(
    GetPostOfficesDocument,
    options
  )
}
export function useGetPostOfficesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetPostOfficesQuery,
    GetPostOfficesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetPostOfficesQuery, GetPostOfficesQueryVariables>(
    GetPostOfficesDocument,
    options
  )
}
export function useGetPostOfficesSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetPostOfficesQuery,
    GetPostOfficesQueryVariables
  >
  ...
  return Apollo.useSuspenseQuery<
    GetPostOfficesQuery,
    GetPostOfficesQueryVariables
  >(GetPostOfficesDocument, options)
}
export type GetPostOfficesQueryHookResult = ReturnType<
  typeof useGetPostOfficesQuery
>
export type GetPostOfficesLazyQueryHookResult = ReturnType<
  typeof useGetPostOfficesLazyQuery
>
export type GetPostOfficesSuspenseQueryHookResult = ReturnType<
  typeof useGetPostOfficesSuspenseQuery
>
export type GetPostOfficesQueryResult = Apollo.QueryResult<
  GetPostOfficesQuery,
  GetPostOfficesQueryVariables
>
 ...
 * });
 */
export function useGetParcelForPageQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetParcelForPageQuery,
    GetParcelForPageQueryVariables
  > &
    (
      | { variables: GetParcelForPageQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetParcelForPageQuery, GetParcelForPageQueryVariables>(
    GetParcelForPageDocument,
    options
  )
}
export function useGetParcelForPageLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetParcelForPageQuery,
    GetParcelForPageQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetParcelForPageQuery,
    GetParcelForPageQueryVariables
  >(GetParcelForPageDocument, options)
}
export function useGetParcelForPageSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetParcelForPageQuery,
    GetParcelForPageQueryVariables
  >
...
export type GetParcelForPageQueryHookResult = ReturnType<
  typeof useGetParcelForPageQuery
>
export type GetParcelForPageLazyQueryHookResult = ReturnType<
  typeof useGetParcelForPageLazyQuery
>
export type GetParcelForPageSuspenseQueryHookResult = ReturnType<
  typeof useGetParcelForPageSuspenseQuery
>
export type GetParcelForPageQueryResult = Apollo.QueryResult<
  GetParcelForPageQuery,
  GetParcelForPageQueryVariables
>
 ...
 * });
 */
export function useParcelStatusUpdatesSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    ParcelStatusUpdatesSubscription,
    ParcelStatusUpdatesSubscriptionVariables
  > &
    (
      | { variables: ParcelStatusUpdatesSubscriptionVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<
    ParcelStatusUpdatesSubscription,
    ParcelStatusUpdatesSubscriptionVariables
  >(ParcelStatusUpdatesDocument, options)
}
export type ParcelStatusUpdatesSubscriptionHookResult = ReturnType<
  typeof useParcelStatusUpdatesSubscription
>
export type ParcelStatusUpdatesSubscriptionResult =
  Apollo.SubscriptionResult<ParcelStatusUpdatesSubscription>
 ...
 * });
 */
export function useGetParcelForSearchQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetParcelForSearchQuery,
    GetParcelForSearchQueryVariables
  > &
    (
      | { variables: GetParcelForSearchQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<
    GetParcelForSearchQuery,
    GetParcelForSearchQueryVariables
  >(GetParcelForSearchDocument, options)
}
export function useGetParcelForSearchLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetParcelForSearchQuery,
    GetParcelForSearchQueryVariables
  >
...
export function useGetParcelForSearchSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    GetParcelForSearchQuery,
    GetParcelForSearchQueryVariables
  >
...
export type GetParcelForSearchQueryHookResult = ReturnType<
  typeof useGetParcelForSearchQuery
>
export type GetParcelForSearchLazyQueryHookResult = ReturnType<
  typeof useGetParcelForSearchLazyQuery
>
export type GetParcelForSearchSuspenseQueryHookResult = ReturnType<
  typeof useGetParcelForSearchSuspenseQuery
>
export type GetParcelForSearchQueryResult = Apollo.QueryResult<
  GetParcelForSearchQuery,
  GetParcelForSearchQueryVariables
>
export type AddDeliveryStatusPayloadKeySpecifier = (
  | 'deliveryStatus'
  | 'errors'
  | AddDeliveryStatusPayloadKeySpecifier
)[]
export type AddDeliveryStatusPayloadFieldPolicy = {
  deliveryStatus?: FieldPolicy<any> | FieldReadFunction<any>
  errors?: FieldPolicy<any> | FieldReadFunction<any>
}
export type AddParcelPayloadKeySpecifier = (
  | 'parcel'
  | AddParcelPayloadKeySpecifier
)[]
export type AddParcelPayloadFieldPolicy = {
  parcel?: FieldPolicy<any> | FieldReadFunction<any>
}
export type AddPostOfficePayloadKeySpecifier = (
  | 'errors'
  | 'postOffice'
  | AddPostOfficePayloadKeySpecifier
)[]
export type AddPostOfficePayloadFieldPolicy = {
  errors?: FieldPolicy<any> | FieldReadFunction<any>
  postOffice?: FieldPolicy<any> | FieldReadFunction<any>
}
export type CollectionSegmentInfoKeySpecifier = (
  | 'hasNextPage'
  | 'hasPreviousPage'
  | CollectionSegmentInfoKeySpecifier
)[]
export type CollectionSegmentInfoFieldPolicy = {
  hasNextPage?: FieldPolicy<any> | FieldReadFunction<any>
  hasPreviousPage?: FieldPolicy<any> | FieldReadFunction<any>
}
export type DeleteDeliveryStatusByIdPayloadKeySpecifier = (
  | 'deliveryStatus'
  | DeleteDeliveryStatusByIdPayloadKeySpecifier
)[]
export type DeleteDeliveryStatusByIdPayloadFieldPolicy = {
  deliveryStatus?: FieldPolicy<any> | FieldReadFunction<any>
}
export type DeleteParcelByIdPayloadKeySpecifier = (
  | 'parcel'
  | DeleteParcelByIdPayloadKeySpecifier
)[]
export type DeleteParcelByIdPayloadFieldPolicy = {
  parcel?: FieldPolicy<any> | FieldReadFunction<any>
}
export type DeletePostOfficeByIdPayloadKeySpecifier = (
  | 'postOffice'
  | DeletePostOfficeByIdPayloadKeySpecifier
)[]
export type DeletePostOfficeByIdPayloadFieldPolicy = {
  postOffice?: FieldPolicy<any> | FieldReadFunction<any>
}
export type DeliveryStatusKeySpecifier = (
  | 'createdAt'
  | 'generalDeliveryState'
  | 'id'
  | 'statusName'
  | 'updatedAt'
  | DeliveryStatusKeySpecifier
)[]
...
export type DeliveryStatusesConnectionKeySpecifier = (
  | 'edges'
  | 'nodes'
  | 'pageInfo'
  | DeliveryStatusesConnectionKeySpecifier
)[]
...
export type DeliveryStatusesEdgeKeySpecifier = (
  | 'cursor'
  | 'node'
  | DeliveryStatusesEdgeKeySpecifier
)[]
...
export type MutationKeySpecifier = (
  ...
  | 'addParcel'
  | 'addPostOffice'
  | 'deleteDeliveryStatusById'
  | 'deleteParcelById'
  | 'deletePostOfficeById'
  | 'pushOneMoreParcelStatus'
...
export type ParcelKeySpecifier = (
  | 'createdAt'
  | 'currentStatus'
  | 'id'
  | 'parcelInfo'
...
export type ParcelHistoryConnectionKeySpecifier = (
  | 'edges'
  | 'nodes'
  | 'pageInfo'
  | ParcelHistoryConnectionKeySpecifier
)[]
...
export type ParcelHistoryEdgeKeySpecifier = (
  | 'cursor'
  | 'node'
  | ParcelHistoryEdgeKeySpecifier
)[]
export type ParcelHistoryEdgeFieldPolicy = {
  cursor?: FieldPolicy<any> | FieldReadFunction<any>
  node?: FieldPolicy<any> | FieldReadFunction<any>
}
export type ParcelInfoKeySpecifier = (
  | 'createdAt'
  | 'deliveryDestinationAddress'
  | 'deliverySourceAddress'
  | 'description'
...
export type ParcelNotFoundErrorKeySpecifier = (
  | 'message'
  | ParcelNotFoundErrorKeySpecifier
)[]
export type ParcelNotFoundErrorFieldPolicy = {
  message?: FieldPolicy<any> | FieldReadFunction<any>
}
export type ParcelStatusKeySpecifier = (
  | 'createdAt'
  | 'date'
  | 'deliveryStatus'
  | 'deliveryStatusId'
...
export type ParcelTrackingServiceErrorKeySpecifier = (
  | 'message'
  | ParcelTrackingServiceErrorKeySpecifier
)[]
export type ParcelTrackingServiceErrorFieldPolicy = {
  message?: FieldPolicy<any> | FieldReadFunction<any>
}
export type ParcelsCursorConnectionKeySpecifier = (
  | 'edges'
  | 'nodes'
  | 'pageInfo'
  | 'totalCount'
  | ParcelsCursorConnectionKeySpecifier
)[]
...
export type ParcelsCursorEdgeKeySpecifier = (
  | 'cursor'
  | 'node'
  | ParcelsCursorEdgeKeySpecifier
)[]
export type ParcelsCursorEdgeFieldPolicy = {
  cursor?: FieldPolicy<any> | FieldReadFunction<any>
  node?: FieldPolicy<any> | FieldReadFunction<any>
}
export type ParcelsOffsetCollectionSegmentKeySpecifier = (
  | 'items'
  | 'pageInfo'
  | 'totalCount'
  | ParcelsOffsetCollectionSegmentKeySpecifier
)[]
...
export type PostOfficeKeySpecifier = (
  | 'address'
  | 'code'
  | 'createdAt'
  | 'id'
  | 'updatedAt'
  | PostOfficeKeySpecifier
)[]
...
export type PostOfficesCursorConnectionKeySpecifier = (
  | 'edges'
  | 'nodes'
  | 'pageInfo'
  | 'totalCount'
  | PostOfficesCursorConnectionKeySpecifier
)[]
...
export type PostOfficesCursorEdgeKeySpecifier = (
  | 'cursor'
  | 'node'
  | PostOfficesCursorEdgeKeySpecifier
)[]
export type PostOfficesCursorEdgeFieldPolicy = {
  cursor?: FieldPolicy<any> | FieldReadFunction<any>
  node?: FieldPolicy<any> | FieldReadFunction<any>
}
export type PostOfficesOffsetCollectionSegmentKeySpecifier = (
  | 'items'
  | 'pageInfo'
  | 'totalCount'
  | PostOfficesOffsetCollectionSegmentKeySpecifier
)[]
...
export type PushOneMoreParcelStatusPayloadKeySpecifier = (
  | 'errors'
  | 'parcel'
  | PushOneMoreParcelStatusPayloadKeySpecifier
)[]
...
export type UpdateDeliveryStatusPayloadKeySpecifier = (
  | 'deliveryStatus'
  | UpdateDeliveryStatusPayloadKeySpecifier
)[]
export type UpdateDeliveryStatusPayloadFieldPolicy = {
  deliveryStatus?: FieldPolicy<any> | FieldReadFunction<any>
}
export type UpdatePostOfficePayloadKeySpecifier = (
  | 'postOffice'
  | UpdatePostOfficePayloadKeySpecifier
)[]
...
export type StrictTypedTypePolicies = {
  AddDeliveryStatusPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AddDeliveryStatusPayloadKeySpecifier
      | (() => undefined | AddDeliveryStatusPayloadKeySpecifier)
  ...
  AddParcelPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AddParcelPayloadKeySpecifier
      | (() => undefined | AddParcelPayloadKeySpecifier)
  ...
  AddPostOfficePayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AddPostOfficePayloadKeySpecifier
      | (() => undefined | AddPostOfficePayloadKeySpecifier)
  ...
  CollectionSegmentInfo?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | CollectionSegmentInfoKeySpecifier
      | (() => undefined | CollectionSegmentInfoKeySpecifier)
  ...
  DeleteDeliveryStatusByIdPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeleteDeliveryStatusByIdPayloadKeySpecifier
      | (() => undefined | DeleteDeliveryStatusByIdPayloadKeySpecifier)
  ...
  DeleteParcelByIdPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeleteParcelByIdPayloadKeySpecifier
      | (() => undefined | DeleteParcelByIdPayloadKeySpecifier)
  ...
  DeletePostOfficeByIdPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeletePostOfficeByIdPayloadKeySpecifier
      | (() => undefined | DeletePostOfficeByIdPayloadKeySpecifier)
  ...
  DeliveryStatus?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeliveryStatusKeySpecifier
      | (() => undefined | DeliveryStatusKeySpecifier)
  ...
  DeliveryStatusesConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeliveryStatusesConnectionKeySpecifier
      | (() => undefined | DeliveryStatusesConnectionKeySpecifier)
  ...
  DeliveryStatusesEdge?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | DeliveryStatusesEdgeKeySpecifier
      | (() => undefined | DeliveryStatusesEdgeKeySpecifier)
  ...
  ParcelHistoryConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelHistoryConnectionKeySpecifier
      | (() => undefined | ParcelHistoryConnectionKeySpecifier)
  ...
  ParcelHistoryEdge?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelHistoryEdgeKeySpecifier
      | (() => undefined | ParcelHistoryEdgeKeySpecifier)
  ...
  ParcelInfo?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelInfoKeySpecifier
      | (() => undefined | ParcelInfoKeySpecifier)
  ...
  ParcelNotFoundError?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelNotFoundErrorKeySpecifier
      | (() => undefined | ParcelNotFoundErrorKeySpecifier)
  ...
  ParcelStatus?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelStatusKeySpecifier
      | (() => undefined | ParcelStatusKeySpecifier)
  ...
  ParcelTrackingServiceError?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelTrackingServiceErrorKeySpecifier
      | (() => undefined | ParcelTrackingServiceErrorKeySpecifier)
  ...
  ParcelsCursorConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelsCursorConnectionKeySpecifier
      | (() => undefined | ParcelsCursorConnectionKeySpecifier)
  ...
  ParcelsCursorEdge?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelsCursorEdgeKeySpecifier
      | (() => undefined | ParcelsCursorEdgeKeySpecifier)
  ...
  ParcelsOffsetCollectionSegment?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | ParcelsOffsetCollectionSegmentKeySpecifier
      | (() => undefined | ParcelsOffsetCollectionSegmentKeySpecifier)
  ...
  PostOffice?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PostOfficeKeySpecifier
      | (() => undefined | PostOfficeKeySpecifier)
  ...
  PostOfficesCursorConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PostOfficesCursorConnectionKeySpecifier
      | (() => undefined | PostOfficesCursorConnectionKeySpecifier)
  ...
  PostOfficesCursorEdge?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PostOfficesCursorEdgeKeySpecifier
      | (() => undefined | PostOfficesCursorEdgeKeySpecifier)
    fields?: PostOfficesCursorEdgeFieldPolicy
  }
  PostOfficesOffsetCollectionSegment?: Omit<
    TypePolicy,
    'fields' | 'keyFields'
  > & {
    keyFields?:
      | false
      | PostOfficesOffsetCollectionSegmentKeySpecifier
      | (() => undefined | PostOfficesOffsetCollectionSegmentKeySpecifier)
  ...
  PushOneMoreParcelStatusPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PushOneMoreParcelStatusPayloadKeySpecifier
      | (() => undefined | PushOneMoreParcelStatusPayloadKeySpecifier)
  ...
  UpdateDeliveryStatusPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | UpdateDeliveryStatusPayloadKeySpecifier
      | (() => undefined | UpdateDeliveryStatusPayloadKeySpecifier)
  ...
  UpdatePostOfficePayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | UpdatePostOfficePayloadKeySpecifier
      | (() => undefined | UpdatePostOfficePayloadKeySpecifier)
